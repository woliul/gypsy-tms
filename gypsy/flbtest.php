    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            <div class="card">
                ...
                <form class=" pl-4 pr-4 pt-4 pb-4 needs-validation" action="../review/process_rating.php?destination=<?php echo urlencode($destination); ?>" method="POST">
                    <div class="text-left mb-3">
                        <label class="" for="email">Rate Your Experience <small
                                    class="text-muted">(required)</small></label>
                        <div class="rating">
                            <input required="" type="radio" name="rating" value="5" id="5"><label class="ml-2 far fa-star"
                                                                                       for="5"></label>
                            <input required="" type="radio" name="rating" value="4" id="4"><label class="ml-2 far fa-star"
                                                                                       for="4"></label>
                            <input required="" type="radio" name="rating" value="3" id="3"><label class="ml-2 far fa-star"
                                                                                      for="3"></label>
                            <input required="" type="radio" name="rating" value="2" id="2"><label class="ml-2 far fa-star"
                                                                                      for="2"></label>
