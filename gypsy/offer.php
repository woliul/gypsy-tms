...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="card card-explore">
                <div class="card-explore__img">
                    <img class="card-img" src="assets/img/explore1.png" alt="">
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="card card-explore">
                <div class="card-explore__img">
                    <img class="card-img" src="assets/img/explore2.png" alt="">
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="card card-explore">
                <div class="card-explore__img">
                    <img class="card-img" src="assets/img/explore3.png" alt="">
                </div>
                <div class="card-body">
