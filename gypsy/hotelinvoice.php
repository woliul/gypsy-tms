                                ...
                                <tr>
                                    ...
                                    <td class="align-middle" style="font-size: 80%;">
                                        <div class="align-middle">
                                            <h5 class="text-truncate font-size-14 mb-1"><?php echo $hname; ?></h5>
                                            <p class="mb-0"><i class="fas fa-restroom"
                                                               style="display: inline-block; margin-right: 5px;font-size: 95%;"></i><?php echo $room; ?>
                                            </p>

                                            <p class="mb-0"><i class="far fa-calendar-alt"
                                                               style="display: inline-block; margin-right: 5px;font-size: 95%;"></i><?php echo $invdate; ?>
                                            </p>
                                    ...
                                    <td class="align-middle">$ <?php  echo $price; ?>
