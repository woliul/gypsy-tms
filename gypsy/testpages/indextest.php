...
<div class="jumbotron headbg1">
    <div class="container">
        ...
        <form class="search-bar" action="../dest.php" method="post">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="destination" id="inputField" placeholder="Search for flights, hotels, or destinations">
