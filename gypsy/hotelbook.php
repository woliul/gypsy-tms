    ...
    <div class="row">
            ...
            <div class="mt-3">
                ...
                <div class="ml-0 pl-0 pr-0 mr-0 mb-2 card-text">
                    ...
                    <div class="pt-3 pl-3 pr-3 mt-3 mb-3 card">
                        <p><strong><i class="fas fa-plane mr-2"></i>Hotel Name</strong></p>

                    </div>
                    <div class="pl-3 pr-3 pt-3 card mt-3 mb-3">
                        <p><strong><i class="fas fa-star"></i> Ratings:</strong>*****</p>
                ...
                <div class="col order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Number of Rooms</h6>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Number of Adults</h6>
                                <small class="text-muted">Brief description</small>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Number of Children</h6>
                                <small class="text-muted">Brief description</small>
                            </div>
        ...
        <div class="col-md-8 order-md-1">
            <div class="card">
                ...
                <form class=" pl-4 pr-4 pt-4 pb-4 needs-validation" action="../review/process_rating.php?destination="
                      method="POST">
