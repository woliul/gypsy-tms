    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            <div class="card">
                ...
                <form class=" pl-4 pr-4 pt-4 pb-4 needs-validation" action="process_rating.php" method="POST">
                    <div class="text-left mb-3">
                        <label class="" for="email">Rate Your Experience <small
                                    class="text-muted">(required)</small></label>
                        <div class="rate">
                            <div class="rating">
                                <input type="radio" name="rating" value="5" id="5"><label class="ml-3 far fa-star"
                                                                                          for="5"></label>
                                <input type="radio" name="rating" value="4" id="4"><label class="ml-3 far fa-star"
                                                                                          for="4"></label>
                                <input type="radio" name="rating" value="3" id="3"><label class="ml-3 far fa-star"
                                                                                          for="3"></label>
                                <input type="radio" name="rating" value="2" id="2"><label class="ml-3 far fa-star"
                                                                                          for="2"></label>
                                <input type="radio" name="rating" value="1" id="1"><label class="far fa-star"
                                                                                          for="1"></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="review" required=""
                    ...
                    <div class="mb-3">
                        <div class="form-label-group">
                            ...
                            <input class="form-control" id="title" placeholder="Summarize your experience"
                    ...
                    <div class="row mb-0">
                        <div class="col-md-6 mb-0">
                            ...
                            <div class="form-label-group">
                                <input autofocus="" class="form-control" id="firstName" placeholder="First name"
                                       required="" type="text">
                        ...
                        <div class="col-md-6 mb-0">
                            ...
                            <div class="form-label-group">
                                <input autofocus="" class="form-control" id="lastName" placeholder="Last name"
                                       required="" type="text">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-label-group">
                            <input autofocus="" class="form-control" id="username" placeholder="Username" required=""
                                   type="text">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-label-group">
                            <input autofocus="" class="form-control" id="email" placeholder="Email address"
                                   type="email">
